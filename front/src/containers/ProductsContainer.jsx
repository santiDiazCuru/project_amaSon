...
class ProductsContainer extends React.Component {
    ...
    render() {
        return (
            <ProductsComponent handleChangeMin={this.handleChangeMin} priceMin={this.state.priceMin} handleClickMin={this.handleClickMin} priceMax={this.state.priceMax} handleChangeMax={this.handleChangeMax} handleClickMax={this.handleClickMax} />
        );
    };
};
